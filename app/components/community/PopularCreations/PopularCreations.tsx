...
export default function PopularCreations({ creators, currentUserId }: Props) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFollowingMap(prev => ({
          ...prev,
          [creator.id]: json.data?.isFollowing ?? !prev[creator.id]
        }));
      }
    ...
    <div className={styles.card}>
      ...
      <div className={styles.list}>
        {creators.map((creator) => {
          const isFollowing = followingMap[creator.id] ?? creator.isFollowing ?? false;
